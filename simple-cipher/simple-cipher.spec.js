...
describe('Random key cipher', () => {
  ...
  //need to make 3 different function prototypes, Key, decode, encode
  //key: has to be a string of letters, greater then 100, and randomly generated.
  //encode: take a string of letters. generate a key. move that string around according to a key. output key and encoded string
  //decode: take an encoded string, and a key, decode the string
